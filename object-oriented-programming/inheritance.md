...
The Circle class has a virtual method called CalculateSurfaceArea that calculates the surface area of a circle. The virtual key word is used to declare that this method is a virtual method and can be overridden. 
